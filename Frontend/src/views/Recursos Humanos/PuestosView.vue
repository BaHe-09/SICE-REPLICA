    ...
    <div class="puestos-page">
      ...
      <div class="filters-bar">
        ...
        <div class="filtros-wrapper">
          <button class="btn-filtros" @click="mostrarFiltros = !mostrarFiltros" :class="{ activo: !!filtroEstatus }" title="Filtros avanzados">
          ...
          <transition name="filtros-slide">
            <div v-if="mostrarFiltros" class="filtros-panel" @click.stop>
              <div class="filtros-panel-header">
                ...
                <button @click="filtroEstatus = ''; currentPage = 1" class="btn-limpiar-filtros">Limpiar</button>
              </div>
...
.filtros-panel { position: absolute; top: calc(100% + 8px); left: 0; width: 240px; background: #FFFFFF; border: 1px solid #E5E7EB; border-radius: 12px; box-shadow: 0 8px 24px rgba(0,0,0,0.12); z-index: 500; overflow: hidden; }
