 ...
 * Respuesta: [{ id_materia, id_materia_prerrequisito,
 *               materia: { nombre }, prerrequisito: { nombre } }]
 *
 * GET /api/materias → [{ id_materia, clave, nombre }]
 */
 ...
 * Body: { id_materia, id_materia_prerrequisito }
 */
const guardar = async () => {
  if (!validar()) return
