...
.celda-acciones{display:flex;gap:7px;align-items:center}.btn-accion{display:flex;align-items:center;gap:5px;padding:6px 13px;border-radius:6px;font-size:0.85rem;cursor:pointer;font-weight:600;font-family:'Montserrat',sans-serif;transition:background 0.15s;white-space:nowrap}.btn-accion svg{width:14px;height:14px}.btn-accion.ver{background:#FFFFFF;color:var(--texto);border:1px solid var(--borde)}.btn-accion.ver:hover{background:var(--fondo)}.btn-accion.editar{background:var(--azul);color:white;border:1px solid var(--azul)}.btn-accion.editar:hover{background:var(--azul-hover)}.btn-accion.planes{background:#DBEAFE;color:var(--azul);border:1px solid #BFDBFE}.btn-accion.planes:hover{background:#BFDBFE}
