...
.toggle-sidebar-btn { background: none; border: none; color: white; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; cursor: pointer; border-radius: 6px; }
.toggle-sidebar-btn:hover { background: rgba(255,255,255,0.15); }
.toggle-icon { width: 24px; height: 24px; stroke: white; }

.header-right { display: flex; align-items: center; gap: 2rem; height: 100%; }

.search-group { position: relative; width: 310px; }
.search-group input { 
  width: 100%; 
...
.search-icon-svg { position: absolute; left: 18px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px; stroke: white; }
